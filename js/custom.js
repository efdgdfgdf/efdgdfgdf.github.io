...
function totraveling() {
  new Vue({
    data: function () {
        this.$notify({
            title: "起飞咯💨",
            message: "即将跳转到「精品实用网络资源导航」，不保证跳转网站的安全性和可用性",
            position: 'top-left',
            offset: 50,
            showClose: true,
            type: "warning",
