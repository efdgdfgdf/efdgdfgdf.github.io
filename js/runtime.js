...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
    ? `<img class='boardsign' src='http://img.shields.io/badge/上班啦-本站正在营业中🛌-28c76f?style=social&logo=foodpanda' title='经典上班摸鱼睡觉🐟'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀   <br><a href="https://www.upyun.com/?utm_source=lianmeng&utm_medium=referral">本网站由<img src="https://img1.imgtp.com/2023/02/11/c8cBOhI0.png" width="45px" />提供CDN加速/云存储服务</a></div> `
    : `<img class='boardsign' src='http://img.shields.io/badge/下班啦-今天的任务都完成了吗💻-red?style=social&logo=Buy Me A Coffee' title='芜湖，兄弟们上号啦TIMI~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀  <br><a href="https://www.upyun.com/?utm_source=lianmeng&utm_medium=referral">本网站由<img src="https://img1.imgtp.com/2023/02/11/c8cBOhI0.png" width="45px" />提供CDN加速/云存储服务</a></div>`),
